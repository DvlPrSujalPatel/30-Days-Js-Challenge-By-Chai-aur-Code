...
// • Task 3: Create a simple form that saves user input (e.g., name and email) to localStorage when submitted. Retrieve and display the saved data on page
// load.
...
// page load te a scrat to remove an item from sessionstorage, Lou the sessionstorate content before and after removal.
