...
// • Task 7: Use the fetch APl to get data from a public APl and log the response data to the console using async/await.
...
// 4. API Fetch Script: Create a script that fetches data from a public AP| using both promises and async/await, and logs the response data.
